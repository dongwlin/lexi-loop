...
// 菜单项（设计系统方案 §8.3 Menu Item 配方）：高亮读 Reka 的 data-highlighted，焦点环在
// outline-hidden 之后必须于 focus-visible 恢复 outline-solid，否则整个配方渲染不出焦点环。
// select 事件与 disabled 等属性未在本组件声明，经 attrs 透传给 Reka。
</script>
